...
films.append("Властелины времени")
films.append("Трудно быть богом")
def save():
    with open("films.json", "w", encoding= "utf-8") as fh:
        fh.write(json.dumps(films,ensure_ascii=False))
    print("Наша фильмотека была успешно сохранина в файле films.json")
...
while True:
    ...
    if command =="/start":
        ...
        print("Неопознанная команда. Просьба изучить манула через /help ")
